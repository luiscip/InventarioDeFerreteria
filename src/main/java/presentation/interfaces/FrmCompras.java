...
public class FrmCompras extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tablaListado.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Stock", "Precio Compra", "Descripción", "Marca", "Estado"
            }
        ) {
        ...
        if (tablaListado.getColumnModel().getColumnCount() > 0) {
            ...
            tablaListado.getColumnModel().getColumn(4).setPreferredWidth(40);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/metodo-de-pago.png"))); // NOI18N
